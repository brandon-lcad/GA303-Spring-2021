...
public class UIController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        public void updateHistoryText(string historyLine)
        {
            if (!convoStarted)
            {
                historyText.text = historyLine;
                convoStarted = true;
            }
            else
            {
