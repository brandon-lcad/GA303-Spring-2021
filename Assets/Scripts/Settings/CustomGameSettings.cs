namespace Settings
{
    ...
    {
        // public enum ContentType { Loot, Quest }
        
        public const string QUEST_ASSETS_PATH = "Assets/Resources";
        public const string ITEM_ASSETS_PATH = "Assets/Resources";
        ...
        public const string ITEM_CREATOR_ICON_PATH = TOOL_ICONS_PATH + "/loot.png";
