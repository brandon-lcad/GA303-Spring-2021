...
public class PlayerController_Hikari : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider other) {
        ...
        else if (other.gameObject.CompareTag("Doorway")) {
            WallFore.GetComponentInChildren<Renderer>().enabled = !WallFore.GetComponentInChildren<Renderer>().enabled;
        }
